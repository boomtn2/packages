...
@interface FVPVideoResolution ()
+ (FVPVideoResolution *)fromList:(NSArray *)list;
+ (nullable FVPVideoResolution *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
@implementation FVPVideoResolution
+ (instancetype)makeWithWidth:(NSInteger )width
    height:(NSInteger )height
    bitRate:(NSInteger )bitRate {
  FVPVideoResolution* pigeonResult = [[FVPVideoResolution alloc] init];
...
+ (FVPVideoResolution *)fromList:(NSArray *)list {
  ...
  pigeonResult.bitRate = [GetNullableObjectAtIndex(list, 2) integerValue];
  return pigeonResult;
}
+ (nullable FVPVideoResolution *)nullableFromList:(NSArray *)list {
  return (list) ? [FVPVideoResolution fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
    @(self.width),
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 129: 
      return [FVPVideoResolution fromList:[self readValue]];
    default:
...
- (void)writeValue:(id)value {
  ...
  } else if ([value isKindOfClass:[FVPVideoResolution class]]) {
    [self writeByte:129];
    [self writeValue:[value toList]];
  } else {
...
void SetUpFVPAVFoundationVideoPlayerApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FVPAVFoundationVideoPlayerApi> *api, NSString *messageChannelSuffix) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.getVideoResolution", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getVideoResolution:error:)], @"FVPAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(getVideoResolution:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        NSInteger arg_textureId = [GetNullableObjectAtIndex(args, 0) integerValue];
        FlutterError *error;
        NSArray<FVPVideoResolution *> *output = [api getVideoResolution:arg_textureId error:&error];
        callback(wrapResult(output, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.changeBandWidth", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(changeBandWidth:forPlayer:error:)], @"FVPAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(changeBandWidth:forPlayer:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        double arg_bandwidth = [GetNullableObjectAtIndex(args, 0) doubleValue];
        NSInteger arg_textureId = [GetNullableObjectAtIndex(args, 1) integerValue];
        FlutterError *error;
        [api changeBandWidth:arg_bandwidth forPlayer:arg_textureId error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
