...
- (void)forPlayer:(NSInteger)textureId bandwidth:(double)mixWithOthers error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable NSArray<FVPVideoResolution *> *)forPlayer:(NSInteger)textureId error:(FlutterError *_Nullable *_Nonnull)error;
@end
