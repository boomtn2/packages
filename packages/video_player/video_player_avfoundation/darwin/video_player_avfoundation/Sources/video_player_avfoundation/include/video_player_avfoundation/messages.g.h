...
@interface FVPVideoResolution : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
/// @return `nil` only when `error != nil`.
- (nullable NSArray<FVPVideoResolution *> *)getVideoResolution:(NSInteger)textureId error:(FlutterError *_Nullable *_Nonnull)error;
- (void)changeBandWidth:(double)bandwidth forPlayer:(NSInteger)textureId error:(FlutterError *_Nullable *_Nonnull)error;
@end
